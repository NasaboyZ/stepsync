...
const useContentStore = create<ContentStore>((set, get) => ({
  contentData: {
    homePage: {
      ...
      imageSrc: aboutImage,
      imageAlt: "Die Beine eines Mannes, der auf der Laufbahn joggt.",
    },
    aboutPage: {
      ...
      imageAlt: "Der sportliche Mann, der auf einem Rollstuhl sitzt",
    },
    aboutTeaser: {
      text: "Josef, der Erfinder von Stepsync, dachte sich, dass wenn man seine Trainingseinheiten auf einer Notiz auf seinem Telefon festhält, dies meistens nicht den nötigen Motivationsschub gibt, um auch eine solche Notiz konstant weiter zu führen. Deshalb hat er diese Plattform erschaffen, damit man auch beim 4. Gang ins Fitnessstudio, auch wenn die Veränderungen nicht sichtbar sind, einen Fortschritt sieht, um die Motivation zu steigern. ",
      imageSrc: runner,
      imageAlt: "Läufer auf der Startlinie.",
    },
    productTeaser: {
      ...
      imageAlt: "Frau macht Bauchtraining",
    },
    productPage: {
