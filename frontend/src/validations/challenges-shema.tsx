...
export const challengesSchema = z.object({
  ...
  goal: z.string()
    .min(3, "Das Ziel muss mindestens 3 Zeichen lang sein")
    .max(200, "Das Ziel darf maximal 200 Zeichen lang sein")
    .regex(
      /^[a-zA-ZäöüÄÖÜß\s0-9.,!?]+$/,
      "Das Ziel darf nur Buchstaben, Zahlen, Leerzeichen und einfache Satzzeichen (.,!?) enthalten"
    )
});
